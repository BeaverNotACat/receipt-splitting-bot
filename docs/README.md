# Documentation
This is an LLM agent service for receipt splitting.
This documentation explains the vision of the project and links to topics that might be helpful for new developers.
## Content
### Domain
